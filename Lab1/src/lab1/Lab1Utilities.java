/**
 * THIS VERSION IS JAN 26 8:26 PM!!!!
 * 
 * Balaji Sathish Kumar
 * 218763979
 */
...
public class Lab1Utilities {
	...
	public static String distanceConverter(double cm) {
		...
		return String.format("%.2fcm is %dft and %.2fin", cm, feet, remainingInches);
	}
	...
	public static String fiveYearBalance(double balance, double interest) {
		...
		return String.format("The balance was %.2f with interest %.2f, after five years balance is %.2f",balance, interest, finalBalance);
	}
